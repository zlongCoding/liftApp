...
import 'package:myapp/widget/bottom_drawer.dart';
...
class CommentDrawer extends StatelessWidget {
  ...
  CommentDrawer(
      {this.host, this.total = 0, this.comments, this.refresh, this.getMore});
                      ...
                      GestureDetector(
                          onTap: () async {
                            final res = await routerGo(
                                context, CommentPages(type: 4, host: host));
                          ...
                          child: Row(children: <Widget>[
                            LiftIcon(code: 0xe6ba, size: 16.0),
                            SizedBox(width: 4.0),
                            Text('写评论')
                          ]))
                    ])
