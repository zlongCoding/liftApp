...
class CommentItem extends StatelessWidget {
  ...
  CommentItem({this.comment, this.floor, this.refresh, this.isBoard = false});
    ...
    list.add(Row(
        ...
        children: <Widget>[
          Row(children: <Widget>[
            ...
            SizedBox(width: 6.0),
            Text(comment.pubtime,
                style: TextStyle(fontSize: 14.0, color: Color(0xffaaaaaa)))
          ]),
          Row(children: <Widget>[
            Text('$floor 楼',
                style: TextStyle(fontSize: fontSize, color: Color(0xffaaaaaa))),
            SizedBox(width: 10.0),
            PopupMenuButton(
                padding: EdgeInsets.all(0.0),
                child: LiftIcon(code: 0xe61c, size: 26.0),
                ...
                itemBuilder: (BuildContext context) => <PopupMenuItem>[
                      PopupMenuItem(value: 'quto', child: Text('引用'))
                    ])
          ])
        ]));
    ...
    if (comment.replycontent != null &&
      ...
      list.add(Container(
          ...
          decoration: BoxDecoration(
              border: Border(
                  left: BorderSide(width: 3.0, color: Color(0xffeeeeee))),
